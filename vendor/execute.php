...
/**************************************************************/
/**************************************************************/
//Codigo para rectificar ruta para eliminar los thumbs
//$path_thumb = $thumbs_base_path2.$_POST['path'];
//echo $path."<br/>".$path_thumb;
$urlThumbDefault = $path_thumb; 
$urlThumbDefault = explode("/", $urlThumbDefault); //

$directory_thumb = [];
foreach($urlThumbDefault as $key => $dir){
	
	if($key == count($urlThumbDefault)-1){
		array_push($directory_thumb, 'thumbs');			
	} 
		array_push($directory_thumb, $dir);
}
 $path_thumb =  implode('/', $directory_thumb); 
