...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="checkbox">
              <label>
                  <strong><input type="checkbox" name="chckbxRequirirDisponibilidad" id="chckbxRequirirDisponibilidad" <?=(@$requerir_disponibilidad?'checked':'')?> value="1" ></strong>
           ...
           <div class="tab-content">
               <div class="tab-pane fade active in" id="div_disponibilidad">
                       <div class="typography">
                           <div class="col-md-12 bg-info" style="padding:0;">
                               <!-- <div class="headline">
               ...
               <div class="tab-pane fade" id="div_bloqueos">
                   <div class="typography">
                       <div class="col-md-12 bg-danger" style="padding:0;">
                          <!-- <div class="headline">
                           <div>BLOQUEOS</div>
                          </div> -->
...
<script type="text/javascript" src="<?=base_url().'assets/js/objetos-buses.js';?>"></script>
...
jQuery(document).ready(function($) {
  ...
  $(document).on('click', '#btn-guardar-disponibilidad', function(event) {
    ...
    $('input:checkbox[name=chckbx_dia]:checked').each(function(){
         array_dias.push( parseInt( $(this).val() ) );
    });
  ...
  $(document).on('change', '.chckbx_dia', function(event) {
    ...
    $('input:checkbox[name=chckbx_dia]').each(function(){
      if( $(this).is(':checked') ){
        ...
        array_dias_no_activos.push( parseInt( $(this).val() ) );
...
function eliminarObjeto(id,uri){
  /**  Ya no se elimina directo, a partir de la segunda versión se elimina cuando el usuario actualiza los datos y la información; primero se elimina toda la información relacionada con el bus y luego se vuelve a insertar con los datos actualizados  **/
  /*
  $.ajax({
