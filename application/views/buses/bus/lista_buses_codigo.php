			...
			<div class="container">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<hr>
						<div>
							<p>Esta pagina tiene <?=count($buses_relacionados['buses']);?> buses en diferentes idiomas disponibles.</p>
							<?php
		...
		(function(){
			...
			lista_buses.on('click','.btn-danger',function(){
				...
				if(confirm('¿Esta seguro de eliminar?')){
					...
					$.post('<?=base_url('buses/unidad/eliminar');?>',{id_bus:id_bus},function(response){
