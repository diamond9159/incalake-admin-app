...
<div class="container-fluid" id="app">
	<div class="row">
		<div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-2 col-sm-offset-2">
			<h2 class="text-primary"><span class="fa fa-edit"></span> AGREGAR PÁGINA WEB</h2><hr/>
			<?php echo form_open('buses/page/add/'.@$codigo_page.'/'.@$selected_idioma,array("class"=>"form-horizontal","id"=>"form_add_page")); ?>
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<input type="text" name="ubicacion_servicio" value="<?php echo $this->input->post('ubicacion_servicio'); ?>" class="form-control validate[required]" id="ubicacion_servicio" autofocus v-model="ubicacion_servicio"/>
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<input type="text" name="titulo_pagina" value="<?php echo $this->input->post('titulo_pagina'); ?>" class="form-control validate[required]" id="titulo_pagina" />
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<textarea name="descripcion_pagina" class="form-control validate[required]" id="descripcion_pagina"><?php echo $this->input->post('descripcion_pagina'); ?></textarea>
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<div class="input-group">
						  	...
						  	<input type="text" name="uri_pagina" value="<?php echo $this->input->post('uri_pagina'); ?>" class="form-control validate[required]" id="uri_pagina" onkeypress="return validarCaracter(event)"/>
						</div>
				...
				<div class="form-group" style="display:none;">
					...
					<div class="col-md-12">
						<input type="text" name="url_pagina" value="<?php echo $this->input->post('url_pagina'); ?>" class="form-control" id="url_pagina" />
            ...
            <div id="titulo_pagina_previa" style="padding: 5px 0;font-size: 18px;color: #1f7ed0;font-family: arial,sans-serif;font-weight: bold;">
              Título de la pagina web (servicio)
            </div>
          
              <div id="url_pagina_previa" style="font-size: 13px;color: #006621;font-style: normal;    font-weight: 700;">
                https://bustickets.incalake.com/es/puno/mi-bus
                        
              </div>
              <div id="descripcion_pagina_previa" style="    color: #6a6a6a">
				...
				<div class="form-group">
					...
					<div class="col-md-12">
				      	<!--input type="file" name="imagen_principal" value="<?php echo $this->input->post('imagen_principal'); ?>" class="form-control" id="imagen_principal" /-->
								<div class="galeriaDivs">
									...
									<input type="hidden" class="inputHideImagenModal" name="imagen_principal">
								</div>
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<!--input type="file" name="miniatura_pagina" value="<?php echo $this->input->post('miniatura_pagina'); ?>" class="form-control" id="miniatura_pagina" /-->
							<div class="galeriaDivs">
									...
									<input type="text" class="inputImagenModal"  readonly>
									<input type="hidden" class="inputHideImagenModal" name="miniatura_pagina">
							</div>
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<div class="checkbox">
						  	<label><input type="checkbox" name="ver_slider" value="1" id="ver_slider"> Mostrar Slider/Ocultar Slider</label>
						</div>
				...
				<div class="form-group">
					...
					<div class="col-md-12 input-star-review">
						<input type="text" name="valoracion_pagina" value="5" class="form-control kv-ltr-theme-fa-star rating-loading" id="valoracion_pagina" data-size="xs" dir="ltr"/>
				...
				<div class="form-group container-fluid" style="padding: 0;">
		            <div class="col-md-12 col-xs-12 col-sm-12" id="div_txt_comentarios">
		                ...
		                <input type="hidden" name="reviews_pagina" class="form-control" id="reviews_pagina" value="<?php echo $this->input->post('reviews_pagina');?>" />
...
<script type="text/javascript">
  ...
  /*********************** END  SCRIPT GESTIONAR  REVIEWS *********************/
	///////////// script para generar previsualizacion en google ////////////////////
			var titulo_pagina = $('#titulo_pagina');
			var descripcion_pagina = $('#descripcion_pagina');
			var uri_pagina = $('#uri_pagina');
			var url_pagina = $('#url_pagina');

			var titulo_pagina_previa = $('#titulo_pagina_previa');
			var url_pagina_previa = $('#url_pagina_previa');
			var descripcion_pagina_previa = $('#descripcion_pagina_previa');
								
			titulo_pagina.on('change keyup',function(){ 
				titulo_pagina_previa.html($(this).val());
			});
			descripcion_pagina.on('change keyup',function(){ 
				descripcion_pagina_previa.html($(this).val());
			});
			uri_pagina.on('change keyup',function(){ 
				url_pagina_previa.html(url_pagina.val()+$(this).val());
			});
	// fin previsualizacion
</script>

<!--AIzaSyCC2CAVXwufsdT5TX3UPk7hZ3HHw3NZl_c-->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBH6k6rZ7O9_O-btoDkMe9QHdgdBGT5SF4&libraries=places&callback=initAutocomplete" async defer></script>
<style type="text/css">
