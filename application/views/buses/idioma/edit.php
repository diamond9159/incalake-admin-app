<div class="container-fluid">
	<div class="row">
		<div class="col-md-4 col-sm-4 col-xs-8 col-md-offset-4 col-sm-offset-4 col-xs-offset-2">
			<h2 class="text-primary"><span class="fa fa-edit"></span> EDITAR IDIOMA</h2><hr/>
			<?php echo form_open('buses/idioma/edit/'.$idioma['id_idioma'],array("class"=>"form-horizontal" ,"id"=>"form_add_idioma")); ?>

				<div class="form-group">
					<label for="pais" class="col-md-12"><span class="fa fa-asterisk text-danger"></span>Idioma: Ejem: Español, Inglés, etc.</label>
					<div class="col-md-12">
						<input type="text" name="pais" value="<?php echo ($this->input->post('pais') ? $this->input->post('pais') : $idioma['pais']); ?>"  class="form-control validate[required]" id="pais" autofocus/>
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						<input type="text" name="codigo" value="<?php echo ($this->input->post('codigo') ? $this->input->post('codigo') : $idioma['codigo']); ?>"  class="form-control validate[required]" id="codigo" style="text-transform: uppercase;"/>
