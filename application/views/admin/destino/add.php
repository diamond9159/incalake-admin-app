<div class="container-fluid">
	<div class="row">		
		...
		<?php echo form_open('admin/destinos/add',array("class"=>"form-horizontal","id" => "form_add_destinos")); ?>
			<?php 
				$helpBlock = true; 
				$autofocus = 'autofocus';
									...
									<div class="col-md-12 col-sm-12 col-xs-12">
										<div class="container-fluid">
											<div class="form-group">
												...
												<input type="text" name="txt_nombre_destino_<?=strtolower($value['codigo']);?>" <?=$autofocus;?> class="form-control validate[required]" id="txt_nombre_destino_<?=strtolower($value['codigo']);?>" placeholder="Ingrese nombre común de sus actividades"/>
												<?php if ($helpBlock): ?>
										...
										<div class="container-fluid">
											<div class="form-group">
												...
												<input type="text" name="txt_uri_destino_<?=strtolower($value['codigo']);?>" class="form-control validate[required]  <?=$replicate;?>" id="txt_uri_destino_<?=strtolower($value['codigo']);?>" placeholder="Ingrese ubicación donde están situado sus actividades"/>
												<?php if ($helpBlock): ?>
						...
						<div class="container-fluid">
							<div class="form-group">
								...
								<div class="galeriaDivs">
									...
									<input type="text" style="padding:5px;border-radius:5px;border:1px solid #CCC;" class="inputImagenModal validate[required]" value="" readonly />
									<input type="hidden" class="inputHideImagenModal" name="txt_id_imagen_slider"  id="txt_id_imagen_slider" value=""/>
					 			</div>
						...
						<div class="container-fluid">
							<div class="form-group">
								...
								<div class="galeriaDivs">
									...
									<input type="text" style="padding:5px;border-radius:5px;border:1px solid #CCC;" class="inputImagenModal validate[required]" value="" readonly />
									<input type="hidden" class="inputHideImagenModal" name="txt_id_imagen_normal"  id="txt_id_imagen_normal" value=""/>
					 			</div>
...
<script type="text/javascript">
	$("#form_add_destinos").validationEngine('attach', {
		relative: true,
