...
<div class="col-md-12 text-right">
    <a class="btn btn-success " href='<?base_url()?>/admin/usuarios/agregar'>Agregar</a>
    	...
    	<?php
    	  foreach ($usuarios as $key => $value) {
            ...
            <div class="col-md-12 born">
                ...
                <div class="col-md-3"><?php echo $value['nombre_usuarios']; ?></div>
                <div class="col-md-3 text-center"><?php echo $value['mail_usuarios']; ?></div>
                <div class="col-md-3 text-right">
                                <a href="<?php echo base_url().'admin/usuarios/editar/'.$value['id_usuarios']; ?>" class="btn btn-info btn-sm"><span class="fa fa-pencil"></span></a> 
                                <?
